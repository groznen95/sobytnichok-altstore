...
# «Что нового» описывает не изменения, а само приложение: версия одна и
# менять её не просили. Человек в магазине читает эту графу, чтобы понять,
# что он ставит, — пусть там будет ответ.
notes = (
    "Каталог\n"
    "• Открыт без регистрации. Поиск и отбор по категориям: суды, политика, "
    "законы, выборы, другое.\n"
    "• Разделы «Сегодня», «Обновлено», «Скоро» — вместо бесконечной ленты.\n\n"
    "Событие\n"
    "• Одно текущее состояние и одно следующее действие с датой.\n"
    "• «Было → стало»: видно, что именно изменилось.\n"
    "• Хроника всех обновлений, участники, описание, ссылки на источники, "
    "до пяти изображений.\n"
    "• Время показывается с той точностью, с какой известно: час, день или "
    "месяц. Если даты нет — так и написано, а не выдуманное число.\n"
    "• Даты считаются в часовом поясе события. В настройках можно "
    "переключить на своё время.\n\n"
    "Подписки\n"
    "• «Следить» за событием, подписки сгруппированы по времени: сегодня, "
    "скоро, без даты, завершённые.\n"
    "• Отметка «новое» у событий, изменившихся с прошлого визита.\n\n"
    "Виджеты\n"
    "• «Ближайшее событие» — на домашнем экране и на экране блокировки, "
    "маленький и средний.\n"
    "• «Мои события» — список подписок, средний и большой.\n"
    "• Время считают сами, без обращений к сети.\n"
    "• Работают и без общего контейнера приложения: тогда показывают "
    "ближайшее событие каталога и помечают его словом «каталог».\n"
    "• Ход события можно вывести на экран блокировки живой активностью.\n\n"
    "Напоминания\n"
    "• Одно уведомление перед назначенным действием: за 15 минут, час, "
    "3 часа или день. По умолчанию выключены.\n"
    "• Больше приложение не присылает ничего.\n\n"
    "Аккаунт\n"
    "• Вход по почте и паролю, вход в два шага с кодами восстановления.\n"
    "• Список устройств с возможностью отозвать доступ, смена пароля и "
    "имени, удаление аккаунта вместе с данными.\n\n"
    "Чего здесь нет: ленты, рекламы, счётчиков и сторонней аналитики."
)
